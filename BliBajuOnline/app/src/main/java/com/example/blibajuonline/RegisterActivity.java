...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateAccount() {
        ...
        String phone = InputName.getText().toString();
        ...
        if (TextUtils.isEmpty(name)){
            ...
            loadingBar.setMessage("Please wait, while we are checking the credentian ");
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!(dataSnapshot.child("users").child(phone).exists())) {
                    ...
                    Toast.makeText(RegisterActivity.this,phone+"sudah bisa masuk",
                            Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(RegisterActivity.this,phone+"sudah dipakai",
                            Toast.LENGTH_SHORT).show();
